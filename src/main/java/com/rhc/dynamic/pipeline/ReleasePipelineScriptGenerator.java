...
public class ReleasePipelineScriptGenerator {
    ...
    private static String generatePromoteImageStage(Engagement engagement, OpenShiftCluster destCluster,
        ...
        if (app.getDeployImageCommands() == null || app.getDeployImageCommands().isEmpty()) {
            ...
            script.append(String.format(
                    ...
                    srcCluster.getOpenshiftHostEnv(), applicationName, destProject.getName(), srcProject.getName(), applicationName));
            if ( shouldVerifyDeployment( applicationName, destProject, engagement ) ) {
                script.append(String.format(
    ...
    private static boolean shouldVerifyDeployment( String applicationName, Project destProject, Engagement engagement  ){
        if ( applicationName.equals("jenkins") && EngagementDAO.isProjectFinalProjectForApplication( destProject, applicationName, engagement ) ){
            return false;
        }
        return true;
    }
